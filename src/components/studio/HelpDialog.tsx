        ...
        <div className="space-y-4">
          ...
          <section>
            ...
            <div className="space-y-1.5 text-xs leading-relaxed text-muted-foreground">
              ...
              <p><span className="font-semibold text-foreground">坐标轴指示器</span>：视口右上角朝向罗盘（X 红 / Y 绿 / Z 蓝，暗点为负方向）实时反映视角；<span className="font-semibold text-foreground">点击轴端平滑对齐视角</span>（保持目标点与距离）；场景面板或 <code className="rounded bg-muted px-1 font-mono text-[10px]">axes off</code> 可关闭；红蓝立体模式下自动隐藏。</p>
