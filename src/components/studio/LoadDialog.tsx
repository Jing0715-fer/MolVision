      ...
      <DialogContent className="mol-elevate-lg gap-0 p-0 sm:max-w-md">
        ...
        <div className="space-y-4 px-4 py-4">
          ...
          <section className="space-y-2">
            <div className="mol-micro text-muted-foreground">PDB 编号</div>
            <form
          ...
          {/* 文件 */}
          <section className="space-y-2">
            <div className="mol-micro text-muted-foreground">本地文件</div>
            <div
            ...
            >
              ...
              <div className="text-[13px] font-medium">点击选择或拖入文件</div>
          ...
          {/* 示例 */}
          <section className="space-y-2">
            <div className="mol-micro text-muted-foreground">经典示例</div>
